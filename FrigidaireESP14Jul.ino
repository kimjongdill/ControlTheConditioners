...
void thermoControl(){
  ...
  // Adjust the temperature after turning the unit on
  ...
  // Ajust the temperature before turning the unit off
  
  else if(desState == 0 && currState == 1){
